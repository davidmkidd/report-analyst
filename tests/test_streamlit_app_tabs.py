...
def test_tabs_exist():
    ...
    for expected_tab in expected_tabs:
        assert expected_tab in tab_labels, f"Tab '{expected_tab}' not found in {tab_labels}"
...
def test_consolidated_results_tab():
    ...
    assert has_consolidated_selectbox, "Question set selectbox not found in Consolidated Results tab"
    assert not at.exception
