...
from app.core.analyzer import DocumentAnalyzer, log_analysis_step
...
def test_env(clean_db):
    ...
    with open(questions_dir / "tcfd_questions.yaml", 'w') as f:
        yaml.dump({
            ...
            'questions': [
                {'id': 'tcfd_1', 'text': "How does the company's board oversee climate-related risks and opportunities?", 'guidelines': 'Test guidelines 1'},
                {'id': 'tcfd_2', 'text': "What is the role of management in assessing and managing climate-related risks and opportunities?", 'guidelines': 'Test guidelines 2'},
                {'id': 'tcfd_3', 'text': "What are the most relevant climate-related risks and opportunities identified by the organisation?", 'guidelines': 'Test guidelines 3'},
                {'id': 'tcfd_4', 'text': "How do climate-related risks and opportunities impact the organisation's business, strategy and financial planning?", 'guidelines': 'Test guidelines 4'},
                {'id': 'tcfd_5', 'text': "How resilient is the organisation's strategy when considering different climate-related scenarios?", 'guidelines': 'Test guidelines 5'},
                {'id': 'tcfd_6', 'text': "What processes does the organisation use to identify and assess climate-related risks?", 'guidelines': 'Test guidelines 6'},
                {'id': 'tcfd_7', 'text': "How does the organisation manage climate-related risks?", 'guidelines': 'Test guidelines 7'},
                {'id': 'tcfd_8', 'text': "How are the processes for identifying, assessing, and managing climate-related risks integrated into overall risk management?", 'guidelines': 'Test guidelines 8'},
                {'id': 'tcfd_9', 'text': "What metrics does the organisation use to assess climate-related risks and opportunities?", 'guidelines': 'Test guidelines 9'},
                {'id': 'tcfd_10', 'text': "Does the organisation disclose its Scope 1, Scope 2, and Scope 3 greenhouse gas emissions?", 'guidelines': 'Test guidelines 10'},
                {'id': 'tcfd_11', 'text': "What targets does the organisation use to understand and manage climate-related risks and opportunities?", 'guidelines': 'Test guidelines 11'}
            ]
        }, f)
...
def analyzer(test_env, clean_db):
    ...
    with patch('app.core.analyzer.OpenAI') as mock_llm, \
        ...
        analyzer._analyze_single_question = Mock(return_value={
            "ANSWER": "Test answer",
            "SCORE": 0.8,
...
async def test_score_chunk_relevance(analyzer):
    ...
    score = await analyzer.score_chunk_relevance(
        "Test question?",
        "Test chunk content"
    )
